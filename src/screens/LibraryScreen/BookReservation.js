...
import {
    Container, Icon, View, Content, Row,
    Col,
} from 'native-base';
            ...
            return (
                <Container>
                    <Content>
                        <View style={{paddingVertical: 10}}>
                            {
                                bookInfo.map(({label, value}) => {
                                    return (
                                        <Row style={{paddingHorizontal: 20, alignItems: 'center'}}>
                                            ...
                                            <Col style={{flex: 6, paddingLeft: 10}}>
                        ...
                        <GradientButton
                            bgColor1={successColor}
                            bgColor2={successDarkColor}
                        ...
                        >
                            <Icon name="checkmark-sharp" type={'Ionicons'} style={{color: 'white'}}/>
