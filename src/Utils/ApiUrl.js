...
export const GET_BOOK_LIST_URI = `${API_URL}books`;
export const GET_BOOK_URI = `${API_URL}book/`;
export const GET_BOOK_FAVORITE_LIST_URI = `${API_URL}book/favoritelist`;
export const POST_BOOK_FAVORITE_LIST_URI = `${API_URL}book/favoritelist`;
export const GET_BOOK_RESERVATION_REQUEST_URI = `${GET_BOOK_URI}booking/request`;
export const POST_BOOK_RESERVATION_URI = `${GET_BOOK_URI}booking/`;
export const GET_BOOK_RESERVATION_URI = `${GET_BOOK_URI}booking`;
